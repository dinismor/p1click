...
import Editempo from "./view/admin_gerir";
      ...
      <Router>
        <div className="App">
          ...
          <Switch>
            ...
            <Route path="/admin_lista_consulta_edit_delete"component={AdminConsultaEditDelete}/>
            <Route path="/admin_editar_consulta/:id"component={AdminConsultaEdit}/>
            <Route path="/admin_listar_consultas"component={AdminListarConsultas}/>
            <Route path="/admin_marcar_consulta"component={AdminMarcarConsulta}/>
            ...
            <Route path="/editar_tempo" component={Editempo} /> 
